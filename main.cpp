...
void admin_will_decide()
{
    ...
    while(true)
    {
    cout<<"\n\nPress 1-To deal with Employee database"<<endl;
...
void front_output()
{
        cout<<"\n\t\tWelcome to  YSR Group of Companies"<<endl;
        cout<<"\nPress 1-Admin"<<endl;
        ...
        if(temp!=NULL)
            {
                ...
                cout<<"\nEmployee Id:"<<temp->e.emp_id<<endl;
            ...
            {
                cout<<"\nThe element doesn't exist"<<endl;
            }
}
int main()
{
